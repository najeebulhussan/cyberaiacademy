...
const INITIAL_PATHWAYS: Pathway[] = [
  {
    id: 'cybersec-ops',
    title: 'Cybersecurity Operations Pathway',
    career: 'SOC Security Analyst',
    salary: '$88,000',
    certifications: 'Cisco CCST Cybersecurity & Cisco CyberOps Associate',
    courseIds: ['intro-cyber', 'networking-essentials', 'cyberops'],
    color: '#0284C7',
    description: 'Master threat analysis, operating system security, network protocols, and secure LLM prompt engineering to defend cloud enterprise assets.',
    longDesc: 'Designed in collaboration with security centers, this track guides you from basic networking definitions to threat detection, packet analysis using Wireshark, and defensive scripting. Ideal for starting as a SOC Analyst, Cloud Guard, or Incident Responder.',
  },
  {
    id: 'netdevops-auto',
    title: 'Network Automation & MLOps Pathway',
    career: 'NetDevOps Engineer',
    salary: '$105,000',
    certifications: 'Cisco Certified DevNet Associate & PCAP Python Specialist',
    courseIds: ['python-essentials-1', 'devnet', 'network-automation-ansible'],
    color: '#6D28D9',
    description: 'Automate network infrastructure using Python, Ansible, and Terraform, and deploy machine learning models inside secure Kubernetes pipelines.',
    longDesc: 'Learn the principles of Infrastructure as Code (IaC). You will build playbooks to configure routers, deploy automated API requests, sanitize LLM inputs, and scale networks safely within corporate staging platforms.',
  }
];
